...
├── …
├── 06-lovushka-null-i-plan-zaprosa.md  ← доп. разбор к теме 6
...
Практика темы должна покрывать паттерны, которые чаще всего дают на SQL-интервью для JOIN нескольких таблиц (без подзапросов, CTE и оконных функций — они в следующих темах программы):
...
Не дублировать одно и то же задание с другим названием отдела. Разные номера задач — разные паттерны.

Перед выдачей сверять набор с актуальными подборками interview-вопросов по JOIN (e-commerce: orders, products, categories, customers).
