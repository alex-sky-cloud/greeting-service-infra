...
2. Для **англоязычных** источников (PostgreSQL docs и т.п.) — цитата EN + перевод RU.
...
- Вы выполняете SQL-запросы, **вставляете текст запроса и результат** (или скрин / описание) в чат.
- Ассистент проверяет: синтаксис, логику, соответствие условию.
...
| 02 | Фильтрация | ✅ | ⬜ | ⬜ | **теория выдана** |
| 03 | Агрегации | ⬜ | ⬜ | ⬜ | не начата |
| 04 | JOIN (inner/left) | ⬜ | ⬜ | ⬜ | не начата |
| 05 | JOIN (несколько таблиц) | ⬜ | ⬜ | ⬜ | не начата |
