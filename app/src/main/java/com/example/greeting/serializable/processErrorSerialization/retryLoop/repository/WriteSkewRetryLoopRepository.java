package com.example.greeting.serializable.processErrorSerialization.retryLoop.repository;
...
/**
 * Репозиторий для варианта retry loop
 * в сценарии write skew.
 */
public interface WriteSkewRetryLoopRepository extends JpaRepository<OnCallDoctorEntity, Long> {
