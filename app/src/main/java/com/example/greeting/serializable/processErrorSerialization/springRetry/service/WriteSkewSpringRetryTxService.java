...
import com.example.greeting.serializable.processErrorSerialization.springRetry.repository.WriteSkewSpringRetryRepository;
 ...
 * для варианта Spring Retry.
 */
@Service
@RequiredArgsConstructor
@Slf4j
public class WriteSkewSpringRetryTxService {

    private final WriteSkewSpringRetryRepository doctorRepository;

    /**
     * Выполняет одну транзакционную попытку
